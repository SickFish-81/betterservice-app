---
name: tech-lead
description: "Use for technical architecture and implementation strategy: system/design decisions, tech-stack and data-model choices, API/state patterns, and turning UX/requirements into a build plan for engineers. Delegate architecture and design-plan work, not line-by-line coding."
model: sonnet
color: orange
---
