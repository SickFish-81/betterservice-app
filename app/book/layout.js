...
export const metadata = pageMeta({
  ...
  description:
    "Book your bike, quad or ATV in for a service or repair at Betterservice ATV, Te Puke. Tell us the machine and the problem and we'll come back to you. Pick-up available.",
  path: "/book",
});
