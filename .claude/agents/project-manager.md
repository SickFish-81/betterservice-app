...
description: "Use to turn requirements/goals into an execution plan: break work into deliverables, sequence dependencies, set milestones and quality gates, and coordinate handoffs between roles. Delegate planning or roadmapping of a feature or phase — not implementation."
model: sonnet
color: purple
---
